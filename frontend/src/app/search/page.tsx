      ...
      {showViewToggle && (
        ...
        >
          ...
          {showViewHelp && (
            ...
            >
              <div style={{ fontWeight: 700, marginBottom: 6 }}>Papers</div>
              <div style={{ color: "#475569", lineHeight: 1.5 }}>
                검색 결과 논문을 카드로 빠르게 확인합니다.
              </div>
              <div style={{ fontWeight: 700, margin: "10px 0 6px" }}>Timeline</div>
              <div style={{ color: "#475569", lineHeight: 1.5 }}>
                키워드 기반 연구 흐름을 타임라인으로 확인합니다.
              </div>
            </div>
          )}
        </div>
